    ...
    public class Patches
    {
        ...
        public static bool CheckEndPatch(LogicGameFlowNormal __instance)
        {
            ...
            else if (!DestroyableSingleton<TutorialManager>.InstanceExists)
            {
                ...
                {
                    PropHuntPlugin.shipStatus.enabled = false;
            ...
            else
            {
                ...
                if (allComplete)
                {
                    ...
                    PropHuntPlugin.shipStatus.Begin();
                }
        ...
        [HarmonyPrefix]
        public static bool ForceNotZeroImps(IGameOptions __instance, ref int __result)
        {
